...
//Get all spender address and allowance info , that account owner address approve.
...
//Get all account owner address and allowance info that spender approved by these addresses.
...
mod tests {
    ...
    use cw20::{Expiration, TokenInfoResponse,Cw20ExecuteMsg,Cw20QueryMsg};
    ...
    fn do_instantiate(mut deps: DepsMut, addr: &str, amount: Uint128) -> TokenInfoResponse {
        let instantiate_msg = InstantiateMsg {
            ...
            max_supply : Uint128::from(100000000000000u128),
            decimals: 3,
            marketing: None,
        };
        ...
        execute(deps.branch(),env.clone(), info.clone(),Cw20ExecuteMsg::Mint{to:addr.to_string() , amount: amount}).unwrap();
    ...
    fn query_all_spender_allowances_works() {
        ...
        let msg = Cw20QueryMsg::AllSpenderAllowances {
            spender: spender.clone(),
            start_after: None,
            limit: None,
        };
